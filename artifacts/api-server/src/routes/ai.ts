...
2. ФУНКЦИОНАЛЬНО ПОЛНЫМ:
   - Весь заявленный функционал должен РАБОТАТЬ
...
Примеры хорошего сайта:
- Hero-секция с анимированным градиентным фоном
- Navbar с blur-эффектом при скролле
- Карточки с hover-трансформациями
