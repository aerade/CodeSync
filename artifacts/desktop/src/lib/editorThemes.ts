...
export function registerCustomThemes(monaco: typeof MonacoType) {
  monaco.editor.defineTheme("codesync-dark", {
    ...
    colors: {
      ...
      "editorBracketMatch.background": "#8B7DE933",
      "editorBracketMatch.border": "#8B7DE955",
