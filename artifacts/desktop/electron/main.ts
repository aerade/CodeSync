...
function buildMenu(): void {
  const template: Electron.MenuItemConstructorOptions[] = [
    ...(process.platform === "darwin" ? [{
      label: "CodeSync",
      submenu: [
        { label: "О программе CodeSync", role: "about" as const },
        { type: "separator" as const },
        { label: "Настройки", accelerator: "Cmd+,", click: () => openSettings() },
        { type: "separator" as const },
        { label: "Выйти из CodeSync", role: "quit" as const },
      ],
    }] : []),
    {
      label: "Правка",
      submenu: [
        { label: "Отменить", role: "undo" as const },
        { label: "Повторить", role: "redo" as const },
        { type: "separator" as const },
        { label: "Вырезать", role: "cut" as const },
        { label: "Копировать", role: "copy" as const },
        { label: "Вставить", role: "paste" as const },
        { label: "Выделить всё", role: "selectAll" as const },
      ],
    },
    {
      label: "Вид",
      submenu: [
        { label: "Перезагрузить", role: "reload" as const },
        { label: "Принудительно перезагрузить", role: "forceReload" as const },
        { type: "separator" as const },
        { label: "Исходный масштаб", role: "resetZoom" as const },
        { label: "Увеличить", role: "zoomIn" as const },
        { label: "Уменьшить", role: "zoomOut" as const },
        { type: "separator" as const },
        { label: "На весь экран", role: "togglefullscreen" as const },
        { type: "separator" as const },
        { label: "Инструменты разработчика", role: "toggleDevTools" as const },
      ],
    },
    {
      label: "Инструменты",
      submenu: [
        { label: "Настройки", accelerator: process.platform === "darwin" ? "Cmd+," : "Ctrl+,", click: () => openSettings() },
      ],
    },
  ];
